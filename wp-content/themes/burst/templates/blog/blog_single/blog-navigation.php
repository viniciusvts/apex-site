...
if (isset($mkd_burst_options['blog_single_navigation']) && $mkd_burst_options['blog_single_navigation'] == "yes"){
    $enable_blog_navigation = true;
}

$navigation_blog_through_category = false;
if (isset($mkd_burst_options['blog_navigation_through_same_category']) && $mkd_burst_options['blog_navigation_through_same_category'] == "yes")
