...
} elseif($mkd_burst_options['portfolio_style'] !== '') {
	$portfolio_template = $mkd_burst_options['portfolio_style'];
}
...
<div class="container" <?php mkd_burst_inline_style($container_styles); ?>>
