...
$default_attrs = array_merge($mkd_burst_IconCollections->getShortcodeParams(), $default_attrs);
...
if(isset($icon_pack) && $icon_pack !== '') {
	...
	$collection_obj = $mkd_burst_IconCollections->getIconCollection($icon_pack);
