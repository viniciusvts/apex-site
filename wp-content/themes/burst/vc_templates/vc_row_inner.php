...
$args = array_merge($args, $mkd_burst_IconCollections->getShortcodeParams('content_menu_'));
...
if ($icon_pack !== '' && $in_content_menu !== '') {
    ...
    $item_collection_icon_obj = $mkd_burst_IconCollections->getIconCollection($icon_pack);
...
if($row_type == 'row') {
    ...
    if($logo_in_content_menu == 'logo_in_content_menu'){
        ...
        if(isset($mkd_burst_options['content_menu_logo_image']) && $mkd_burst_options['content_menu_logo_image'] != ""){
            $logo_image = $mkd_burst_options['content_menu_logo_image'];
        }else if(isset($mkd_burst_options['logo_image']) && $mkd_burst_options['logo_image'] != ""){
            $logo_image = $mkd_burst_options['logo_image'];
        }
    ...
    if($custom_widget_area !== ''){
        ...
        $output .= mkd_burst_get_dynamic_sidebar($custom_widget_area);
        $output .= '</div></div></div>';
    }
