...
if($type=="price_on_top" ){
    $html .= "<li class='prices' " . mkd_burst_get_inline_style(array($price_background_style,"border-color: ".$border_arround_color.";")) . ">";
    $html .= "<div class='price_in_table'>";
    $html .= "<sup class='value'>".$currency."</sup>";
    $html .= "<span class='price' ".mkd_burst_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";

    $html .= "</div>"; // close div.price_in_table
    $html .= "</li>"; //close li.prices
    $html .= "<li class='cell table_title ".$title_clasess."' ".mkd_burst_get_inline_style(array($title_holder_style,"border-color: ".$border_arround_color.";"))."><span class='title_content' ".$title_style.">".$title."</span>";
...
if($type=="title_on_top"){	
    $html .= "<li class='cell table_title ".$title_clasess."' ".mkd_burst_get_inline_style(array($title_holder_style,"border-color: ".$border_arround_color.";")).">";
    $html .= "<span class='title_content' ".$title_top_type_title_style.">".$title."</span>";
    $html .= "</li>";    

    $html .= "<li class='prices $pricing_content_clasess' ".mkd_burst_get_inline_style(array($price_background_style,"border-color: ".$border_arround_color.";")).">";
    $html .= "<div class='price_in_table'>";
    $html .= "<sup class='value'>".$currency."</sup>";
    $html .= "<span class='price' ".mkd_burst_get_inline_style($price_style_array).">".$price."</span>";
    $html .= "<span class='mark'>/ ".$price_period."</span>";
...
if($show_button == "yes"){
	if($pricing_button_type == "standard_button"){
		if(isset($button_text) && $button_text !== '') {
			$html .="<li class='price_button $button_class' ".mkd_burst_get_inline_style($button_holder_style)." >";
			if($type=="title_on_top"){
				$html .= "<div class='title_on_top_button_wrapper $disable_button_border_top_class'>";
				$html .= "<a ".mkd_burst_get_inline_style($button_style)." href='$link' target='$target'>".$button_text."";
				if($button_arrow == "yes"){
		...
		$html .="<a class='button_on_bottom' ".mkd_burst_get_inline_style($button_on_bottom_styles)." href='$link' target='$target'></a>";
		$html .="</li>";//close li.price_button
	}
}
