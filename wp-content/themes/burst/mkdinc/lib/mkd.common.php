...
$mkd_burst_options_fontstyle = array( "normal" => "normal",
 "italic" => "italic"
);
$mkd_burst_options_fontweight = array( "100" => "100",
 "200" => "200",
 "300" => "300",
 "400" => "400",
 "500" => "500",
...
$mkd_burst_options_texttransform = array( "none" => "None",
 "capitalize" => "Capitalize",
 "uppercase" => "Uppercase",
 "lowercase" => "Lowercase"
);

$mkd_burst_options_fontdecoration = array( "none" => "none",
 "underline" => "underline"
);

$mkd_burst_options_arrows_type = array(
...
$mkd_burst_options_double_arrows_type = array(
	'fa fa-angle-double-' => 'fa-angle-double',
	'arrow_carrot-2' => 'arrow_carrot-2',
	'arrow_carrot-2left_alt2' => 'arrow_carrot 2 alt2',
	'icon-arrows-left-double-32' => 'icon-arrows double',
...
$mkd_burst_options_arrows_up_type = array(
...
$mkd_burst_options_blockquote_type = array(
