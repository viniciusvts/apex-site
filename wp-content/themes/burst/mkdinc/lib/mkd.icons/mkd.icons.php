...
/*
  Class: MikadoBurstIconCollections
...
class MikadoBurstIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new MikadoBurstIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new MikadoBurstIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new MikadoBurstIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new MikadoBurstIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new MikadoBurstSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new MikadoBurstDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iMikadoBurstIconCollection $collection) {
...
$mkd_burst_IconCollections = MikadoBurstIconCollections::get_instance();