 ...
 */
class Mikado_Burst_Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    /**
    ...
    <li id="menu-item-<?php echo esc_attr($item_id); ?>" class="<?php echo esc_attr(implode(' ', $classes )); ?>">
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr($item_id); ?>">
			...
			<?php
            $iconCollections = $mkd_burst_IconCollections->getIconCollectionsEmpty();
            ...
            if(is_array($iconCollections) && count($iconCollections)) {
                ...
                $collection_obj = $mkd_burst_IconCollections->getIconCollection($item->icon_pack);
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                    <p class="link-to-original">
                        <?php printf( esc_html__('Original: %s', 'burst'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                    </p>
                <?php endif; ?>
