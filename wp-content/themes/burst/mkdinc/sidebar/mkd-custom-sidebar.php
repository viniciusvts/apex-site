...
if( ! class_exists('mkd_burst_sidebar') ){
	
	class mkd_burst_sidebar{
		...
		function load_assets(){
			...
			wp_enqueue_script('mkd_burst_sidebar' , MIKADO_ROOT . '/mkdinc/admin/assets/js/mkdf-sidebar.js');
			wp_enqueue_style( 'mkd_burst_sidebar' , MIKADO_ROOT . '/mkdinc/admin/assets/css/mkdf-sidebar.css');
		}
