...
if(!function_exists('mkd_burst_get_portfolio_image_meta')) {
	function mkd_burst_get_portfolio_image_meta($image_src) {
		global $wpdb;
...
if (!function_exists('mkd_burst_ComparePortfolioImages')) {
	/**
	 ...
	 */
	function mkd_burst_ComparePortfolioImages($a, $b){
...
if (!function_exists('mkd_burst_ComparePortfolioOptions')){
	/**
	 ...
	 * @return int result of comparison
	 */
	function mkd_burst_ComparePortfolioOptions($a, $b){
