...
?>
	...
	?>
		...
		<?php if(isset($mkd_burst_options['woo_products_enable_full_width_template'])&& $mkd_burst_options['woo_products_enable_full_width_template']=="yes" && !is_singular('product')){ ?>
		...
		<?php } ?>
		<?php if(isset($mkd_burst_options['woo_products_enable_full_width_template'])&& $mkd_burst_options['woo_products_enable_full_width_template']=="yes" && !is_singular('product')){ ?>
			<div class="full_width_inner" <?php mkd_burst_inline_style($content_style); ?>>
		<?php } else{ ?>
				...
				<?php if(!is_singular('product')) { ?>
					<?php if(($sidebar == "default")||($sidebar == "")) : ?>
						<div class="page-decription_holder">
							<?php mkd_burst_woocommerce_content_before(); ?>
						</div>
						<?php mkd_burst_woocommerce_content(); ?>
					<?php elseif($sidebar == "1" || $sidebar == "2"): ?>		
					<?php global $woocommerce_loop;
			        	$woocommerce_loop['columns'] = 3;
			        ?>
					<?php if(isset($mkd_burst_options['woocommerce_product_list_content_position']) && $mkd_burst_options['woocommerce_product_list_content_position'] == 'content_above_product_list_and_sidebar') { ?>
						<div class="page-decription_holder">
							<?php mkd_burst_woocommerce_content_before(); ?>
						</div>
					<?php }	?>
					...
					<?php endif; ?>
								<div class="column_inner">
									<?php if(isset($mkd_burst_options['woocommerce_product_list_content_position']) && $mkd_burst_options['woocommerce_product_list_content_position'] == 'content_above_product_list') { ?>
											<div class="page-decription_holder">
												<?php mkd_burst_woocommerce_content_before(); ?>
											</div>
									<?php }	?>
